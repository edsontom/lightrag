...
4. For time-specific queries, prioritize temporal information in the content before considering creation timestamps
5. Carefully assess the relevance of the supporting materials to the user's question. Some materials may have been incorrectly included and may not help answer the user's question. You may choose not to use them.
---Conversation History---
{history}
...
- Carefully assess the relevance of the supporting materials to the user's question. Some materials may have been incorrectly included and may not help answer the user's question. You may choose not to use them.
- When the supplied information does not relate to the question, respond with: 'I cannot provide a correct answer based on the provided materials.'
